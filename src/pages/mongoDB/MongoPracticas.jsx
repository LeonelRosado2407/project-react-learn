      ...
      <div className="grid grid-cols-2 gap-8">
        ...
        <div>
            <div className="w-full rounded-lg shadow bg-gray-700 ">
                ...
                <div className="p-5">
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        Práctica de Agregar Usuarios consumiendo una API de MongoDB
                    </h5>
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                        Usando el Post
                    </p>
        ...
        <div>
            <div className="w-full rounded-lg shadow bg-gray-700 ">
                ...
                <div className="p-5">
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        Práctica de Actualizar Datos de Usuarios consumiendo una API de MongoDB
                    </h5>
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                        Usando el Put
                    </p>
        ...
        <div>
            <div className="w-full rounded-lg shadow bg-gray-700 ">
                ...
                <div className="p-5">
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        Práctica de Eliminar Usuarios consumiendo una API de MongoDB
                    </h5>
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                        Usando el Delete
                    </p>
                    <Link to="/UsuariosMongo/EliminarUsuario">
